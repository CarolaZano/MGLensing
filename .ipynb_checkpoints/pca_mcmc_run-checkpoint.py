...
L_ch_inv = np.matrix(np.loadtxt("/home/c2042999/MGLensing/ini_files/pca/Cholesky_inv_SRD.txt")) #L_choleski_inv_uncut
...
def main():
    ...
    start = time.time()
    print("starting")
    sampler.run(verbose=MGL_mu_lin.mcmc_verbose, discard_exploration=True, n_eff=3000)
